  ...
  <div>
    ...
    <div class="top-bar">
      <div class="left-section">
        ...
        <span class="system-subname">信息管理子系统 - 教师主页</span>
      </div>
        ...
        <section class="quick-actions-large">
          <div class="large-actions-grid">
            <router-link
              ...
              class="action-card-large card-style-submit-grades"
            >
              <div>
                <div class="card-large-title">提交成绩</div>
            ...
            <router-link
              to="../teacher/taught-courses"
              class="action-card-large card-style-my-courses"
            >
              <div>
                <div class="card-large-title">我的课程</div>
                <hr class="card-large-divider" />
                <FontAwesomeIcon
            ...
            <router-link
              to="../teacher/edit-course"
              class="action-card-large card-style-edit-course"
            >
              <div>
                <div class="card-large-title">修改课程信息</div>
                <hr class="card-large-divider" />
                <FontAwesomeIcon
                  :icon="['fas', 'fa-edit']"
                  class="card-large-icon"
            ...
            <router-link
              to="../teacher/request-grade-change"
              class="action-card-large card-style-request-grade-change"
            >
              <div>
                <div class="card-large-title">修改已提交成绩</div>
                <hr class="card-large-divider" />
                <FontAwesomeIcon
                  :icon="['fas', 'fa-history']"
                  class="card-large-icon"
            ...
            >
              <div>
                <div class="card-large-title">查询课程</div>
                <hr class="card-large-divider" />
                <FontAwesomeIcon
            ...
            <router-link
              to="../teacher/course-grade-analysis"
              class="action-card-large card-style-analysis"
            >
              <div>
                <div class="card-large-title">课程成绩分析</div>
                <hr class="card-large-divider" />
                <FontAwesomeIcon
...
/* Specific Card Icon Colors for Teacher Dashboard */
.action-card-large.card-style-submit-grades .card-large-icon {
  color: #67c23a;
}
.action-card-large.card-style-my-courses .card-large-icon {
  color: #409eff;
}
.action-card-large.card-style-edit-course .card-large-icon {
  color: #e6a23c;
}
.action-card-large.card-style-request-grade-change .card-large-icon {
  color: #f56c6c;
} /* Red for attention */
